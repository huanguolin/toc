...
export type BuildFunObj<D extends FunStmt, E extends Environment> = {
    declaration: D;
    environment: E;
};
...
export type GetFunName<F extends FunObject> =
...
> = Params extends [infer T extends Token, ...infer R extends Token[]]
    ...
    : Result;
type Combine<A extends string, B extends string> = A extends ''
    ? B
    : `${A}, ${B}`;
