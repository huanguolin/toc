...
export type Pop<A extends any[]> = A extends [...infer R, infer E]
    ? { array: R; element: E }
    : never;
// type tPop = Pop<[5]>;

export type Drop<A extends any[], N extends number = 1> = A extends [
    ...infer R extends any[],
    ...Init<N>,
]
    ? R
...
export type Slice<A extends any[], I extends number> = A extends [
    ...Init<I>,
    ...infer R extends any[],
]
    ? R
...
export type Init<
    ...
    E extends any = any,
    A extends any[] = [],
> = Length<A> extends L ? A : Init<L, E, Push<A, E>>;
