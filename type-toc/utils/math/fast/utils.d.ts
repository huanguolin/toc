...
export type ToNumChars<
    N extends number,
> = Safe<ToNumCharsBody<`${N}`, []>, NumChars[]>;
type ToNumCharsBody<
    S extends string,
    R extends string[] = [],
> = S extends `${infer NC}${infer Rest}`
    ? ToNumCharsBody<Rest, [...R, NC]>
    : R;
...
export type TrimZeroStart<N extends NumChars[]> = N extends ['0', ...infer R extends NumChars[]]
    ? TrimZeroStart<R>
    : N extends []
        ? ['0'] // Keep one at least.
        : N;