...
type ParseLogicOr<
    Tokens extends Token[],
    R = ParseLogicAnd<Tokens>,
> = R extends ParseExprSuccess<infer Left, infer Rest>
    ? ParseLogicOrBody<Left, Rest>
    : R;
type ParseLogicOrBody<
    Left extends Expr,
    Tokens extends Token[],
...
type ParseLogicAnd<
    Tokens extends Token[],
    R = ParseEquality<Tokens>,
> = R extends ParseExprSuccess<infer Left, infer Rest>
    ? ParseLogicAndBody<Left, Rest>
    : R;
type ParseLogicAndBody<
    Left extends Expr,
    Tokens extends Token[],
> = Tokens extends Match<infer Op extends TokenLike<'&&'>, infer Rest>
...
type ParseEquality<
    Tokens extends Token[],
    R = ParseRelation<Tokens>,
> = R extends ParseExprSuccess<infer Left, infer Rest>
    ? ParseEqualityBody<Left, Rest>
    : R;
type ParseEqualityBody<
    Left extends Expr,
    Tokens extends Token[],
> = Tokens extends Match<infer Op extends TokenLike<'==' | '!='>, infer Rest>
...
type ParseRelation<
    Tokens extends Token[],
    R = ParseAdditive<Tokens>,
> = R extends ParseExprSuccess<infer Left, infer Rest>
    ? ParseRelationBody<Left, Rest>
    : R;
type ParseRelationBody<
    Left extends Expr,
    Tokens extends Token[],
> = Tokens extends Match<
    infer Op extends TokenLike<'>' | '<' | '>=' | '<='>,
    infer Rest
>
...
type ParseAdditive<
    Tokens extends Token[],
    R = ParseFactor<Tokens>,
> = R extends ParseExprSuccess<infer Left, infer Rest>
    ? ParseAdditiveBody<Left, Rest>
    : R;
type ParseAdditiveBody<
    Left extends Expr,
    Tokens extends Token[],
> = Tokens extends Match<infer Op extends TokenLike<'+' | '-'>, infer Rest>
...
// unary part
type ParseUnary<Tokens extends Token[]> = Tokens extends Match<
    infer Op extends TokenLike<'!'>,
    infer Rest
>
        ...
        ? Rest extends Match<TokenLike<')'>, infer Rest>
            ...
            ? AR extends ParseArgsSuccess<infer Args, infer Rest>
                ? Rest extends Match<TokenLike<')'>, infer Rest>
                    ? ParseCall<
                          Rest,
                          ParseExprSuccess<BuildCallExpr<Callee, Args>, Rest>
                      >
...
type ParseArgsSuccess<R extends Expr[], T extends Token[]> = SuccessResult<{
    args: R;
    rest: T;
}>;
type ParseArgs<
...
// primary part
type ParsePrimary<Tokens extends Token[]> = Tokens extends Match<
    infer E extends Token,
    infer R
>
