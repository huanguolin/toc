...
export type ParseStmtSuccess<
    R extends Stmt,
    T extends Token[],
> = SuccessResult<{ stmt: R; rest: T }>;

export type ParseDecl<Tokens extends Token[]> = Tokens extends Match<
    TokenLike<'var'>,
    infer Rest
>
    ? ParseVarStmt<Rest>
...
type ParseStmt<Tokens extends Token[]> = Tokens extends Match<
    TokenLike<'{'>,
    infer Rest
>
    ? ParseBlockStmt<Rest>
...
type ParseForStmt<Tokens extends Token[]> = Tokens extends Match<
    TokenLike<'('>,
    infer Rest
>
...
type ParseForStmtFromInitializerResult<IR> = IR extends ParseStmtSuccess<
    infer Initializer,
    infer Rest
>
...
> = BR extends ParseStmtSuccess<infer Body, infer Rest>
    ? ParseStmtSuccess<
          BuildForStmt<Initializer, Condition, Increment, Body>,
          Rest
      >
    : BR; // error

type ParseFunStmt<Tokens extends Token[]> = Tokens extends Match<
    infer Name extends Identifier,
    infer Rest
>
        ...
        ? PR extends Match<infer Params extends Identifier[], infer Rest>
            ? Rest extends Match<TokenLike<'{'>, infer Rest>
                ? ParseBlockStmt<Rest> extends infer BR
                    ? BR extends ParseStmtSuccess<
                          infer Body extends BlockStmt,
                          infer Rest
                      >
                        ? ParseStmtSuccess<
                              BuildFunStmt<Name, Params, Body>,
                              Rest
                          >
                        : BR // error
...
type ParseFunParams<Tokens extends Token[]> = Tokens extends Match<
    TokenLike<'('>,
    infer Rest
>
    ? Rest extends Match<TokenLike<')'>, infer Rest>
...
type ParseIfStmt<Tokens extends Token[]> = Tokens extends Match<
    TokenLike<'('>,
    infer Rest
>
                    ...
                    ? IfSR extends ParseStmtSuccess<infer IfClause, infer Rest>
                        ? Rest extends Match<TokenLike<'else'>, infer Rest>
                            ? ParseStmt<Rest> extends infer ElseSR
                                ? ElseSR extends ParseStmtSuccess<
                                      infer ElseClause,
                                      infer Rest
                                  >
                                    ? ParseStmtSuccess<
                            ...
                            : ParseStmtSuccess<
                                  BuildIfStmt<Condition, IfClause, null>,
                                  Rest
                              >
                        : IfSR // error
...
type ParseBlockStmtBody<SR, Stmts extends Stmt[]> = SR extends ParseStmtSuccess<
    infer S,
    infer R
>
...
type ParseVarStmt<Tokens extends Token[]> = Tokens extends Match<
    infer VarName extends Identifier,
    infer Rest
>
    ? Rest extends Match<TokenLike<';'>, infer Rest>
