...
export type InterpretStmtError<M extends string> =
    ErrorResult<`[InterpretStmtError]: ${M}`>;
export type InterpretStmtSuccess<
    Value extends ValueType,
    Env extends Environment,
> = SuccessResult<{ value: Value; env: Env }>;

export type InterpretStmt<
    S extends Stmt,
    Env extends Environment,
> = S extends VarStmt
...
type InterpretIfStmt<S extends IfStmt, Env extends Environment> = InterpretExpr<
    S['condition'],
    Env
> extends infer CR
